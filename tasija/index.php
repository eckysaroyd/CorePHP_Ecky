...
<head>
    ...
    <title> TASIJA Voting System</title>
...
<!-- Header -->
<nav class="navbar navbar-inverse bg-success navbar-light navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php">TASIJA Voting</a>
        </div>
...
<!-- Footer -->
<nav class="navbar navbar-inverse navbar-fixed-bottom p-5" role="navigation">

    <div class="container">
        <div class="navbar-text pull-left">
             <p>&copy; <?php echo date("Y"); ?> &nbsp; <a href="#/" target="_blank">TASIJA</a>, All Rights Reserved.</p>
        </div>
    </div>
