       ...
       <?php include('include/navbar.php'); ?>
        ...
        <div class="row" style="color: #ed9e21">
            <div class="col-md-12 well" >
              ...
              <p>Customers can lease space at cospace for housing or working purposes. This is a simple app that allows all users to book their needs. </p>
            </div>  
        </div>
        <div class="row" style="color: #ffbb2b">
            <div class="col-md-6 wellfix">
              <h4><strong>Our Team</strong></h4><hr>
              Ruhani -22071289<br>
              Kabir -22071280<br>
              Balwinder -22071290<br>
              Eckysaroyd -22071284<br>
            </div>
        </div>
    </div>
