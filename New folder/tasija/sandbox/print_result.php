        ...
        <div class="col-md-12">
            ...
            if(!isset($_GET['organization'])) {
                ...
                <div class="logo-title">
                    ...
                    <table>
                        <tr>
                            <td><img src="../assets/img/TASIJALOGO.jpg" style="width:70px;height:70px;"></td>
                            <td><br/>
                                <p style="text-align: left;">
                                    <b>TASIJA 2021 Election,</b><br />
...
<nav class="navbar navbar-inverse navbar-fixed-bottom" role="navigation">
    ...
    <div class="container">
        <div class="navbar-text pull-left">
             <p>&copy; <?php echo date("Y"); ?> &nbsp; <a href="https://ultimaxdev.com/" target="_blank">UltimaxDev</a>, All Rights Reserved.</p>
        </div>
    </div>
